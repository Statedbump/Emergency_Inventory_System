...
create table resource(r_id serial primary key,r_type varchar(100)
,r_quantity integer,r_location varchar(150),r_price float,r_availability BOOLEAN );
...
create table water(w_id serial primary key,r_id integer references resource(r_id), water_type varchar(50),measurement_unit varchar(50));
