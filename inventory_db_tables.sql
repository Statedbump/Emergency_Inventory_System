...
create table resource_order(o_id serial primary key,o_date DATE,o_quantity integer,r_list TEXT);
...
create table buys(r_id integer references resource(r_id), o_id integer references resource_order(o_id),total_price float,
